...
class MyRNN(tf.keras.Model):
    ...
    def __init__(self, vocab_size, rnn_size=128, embed_size=64):
        ...
        self.dense = tf.keras.layers.Dense(self.vocab_size, activation=tf.keras.activations.softmax)
...
def main():
    ...
    data_path = "../data"
    train_id, test_id, vocab = get_data(f"{data_path}/train.txt", f"{data_path}/test.txt")
